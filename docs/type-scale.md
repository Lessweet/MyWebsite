...
| Token | 字号 | 对应实现 | 用在哪 |
|---|---|---|---|
| `--fs-h1` | 56px | `<h1>` 大标题 | 文章标题 `.article-h1`(字重 500,桌面/手机统一) |
...
| `--fs-caption` | 14px | 小字(无单一标签) | 简介 `.w-excerpt/.a-excerpt`、日期 `.w-date/.card-date/.a-date`、tag `.a-tag`、图注 `.img-caption`、byline、`.same-collection`、`.ft-desc`、`.back-link`、左栏列表文字 |
