...
let READER_ARTICLES = [
    { file: "article-claude-code-verification-loops.html", cat: "product", title: "验证循环，把手动检查写进 Skill", date: "2026-07-23", cover: "assets/claude-code-verification-loops/cover2.png", accent: "#C55B10" },
